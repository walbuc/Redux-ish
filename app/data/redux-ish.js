...
export function createStore(reducer, state, middleware) {
  ...
  // while dispatch is running a reducer,
  // ensure the reducer is not calling the dispatch
  // and create a loop.
  // If this happens the finally block will break the loop.
  const dispatch = (action) => {
    ...
    // observable pattern
    // update subscribers and call the listeners
